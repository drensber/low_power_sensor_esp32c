...
add_dependencies(low_power_sensor_esp32c low_power_sensor_lpcore)
sysbuild_add_dependencies(CONFIGURE low_power_sensor_esp32c low_power_sensor_lpcore)
sysbuild_add_dependencies(FLASH low_power_sensor_lpcore low_power_sensor_esp32c)

if(SB_CONFIG_BOOTLOADER_MCUBOOT)
  # Make sure MCUboot is flashed first
  sysbuild_add_dependencies(FLASH low_power_sensor_esp32c mcuboot)
endif()
